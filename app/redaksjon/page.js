...
function NewsRadar({ items, settings, runStatus, livePulseStatus }) {
  ...
  return <>
    <EditorialAutomationControls initialSettings={settings} initialRunStatus={runStatus} initialLivePulseStatus={livePulseStatus}/>
    <AutopilotControl/>
    <div className="sourceToolbar">
    ...
    <main className="adminShell">
      ...
      <div className="adminContentGrid">
        <section className="adminMain">
          ...
          {active === 'radar' && <NewsRadar items={data.radarItems} settings={data.editorialSettings} runStatus={data.editorialRunStatus} livePulseStatus={data.livePulseStatus}/>} 
