...
export async function generateArticleDraftFromRadar(id) {
  ...
  const verification = {
    ...
    unsupportedClaims: [],
    numberIssues: [],
    notes: 'Grundig AI-faktasjekk kjøres separat i redaksjonen.',
  };
  ...
  const validationNote = numeric.pass
    ? 'Utkast lagret. Automatisk tallkontroll mot faktapakken bestått. Grundig AI-faktasjekk gjenstår før publisering.'
