...
- source_url skal alltid kopieres nøyaktig fra main_source.url eller supporting_source.url. Ikke konstruer, gjett eller forkort URL-er.
...
export async function buildFactPackForRadarItem(id) {
  ...
  await sql`
    ...
    VALUES (
      ...
      ${pack.marketRelevance || null}, ${JSON.stringify(pack.analysisSignals)}::jsonb, ${pack.canWrite}, ${pack.confidence}, ${MODEL},
