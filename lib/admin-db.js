...
export async function getAdminData() {
  ...
  return { queue, published, feed, sources, usage, liveOrder, policyRate: policyRate[0] || null, rawItems, radarItems, editorialSettings, editorialRunStatus: latestScheduledRun[0] || null, livePulseStatus: latestLivePulse };
}
